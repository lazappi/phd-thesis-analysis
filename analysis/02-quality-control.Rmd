...
exp_plot <- ggplot(plot_data,
    ...
    xlab("Total counts (log10)") +
    ylab("Total features (log10)") +
    theme_minimal() +
...
pca_plot <- ggplot(plot_data, aes(x = PC1, y = PC2, colour = Removed)) +
    geom_point(alpha = 0.3) +
    scale_colour_manual(values = c("#F47920", "#00B7C6", "grey50"),
                        name = "Removed by") +
...
fc_plot <- ggplot(plot_data,
    ...
    scale_colour_viridis_c(
        name = "Proportion expressed (Removed) - Proportion expressed (Kept)"
    ) +
...
plot_list <- list(
    ...
    ggplot(plot_data, aes(x = TSNE1, y = TSNE2, colour = `Cell cycle`)) +
        scale_colour_manual(values = c("#EC008C", "#00ADEF", "#8DC63F")) +
        ggtitle("Cell cycle stage"),
    ggplot(plot_data, aes(x = TSNE1, y = TSNE2, colour = `Total counts (log10)`)) +
        scale_colour_viridis_c() +
        ggtitle("Total counts (log10)"),
    ggplot(plot_data, aes(x = TSNE1, y = TSNE2, colour = `Total features (log10)`)) +
        scale_colour_viridis_c() +
        ggtitle("Total features (log10)"),
