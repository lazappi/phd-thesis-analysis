...
EmptyDrops were kept giving a dataset with `r params$pre$n_cells` cells. Gene 
annotation information was added from BioMart [@Smedley2015-an] using the
biomaRt package (v`r versions$biomaRt`) [@Durinck2005-zb] and cells were
